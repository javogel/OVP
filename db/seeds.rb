...
# User.create(provider: User.first.provider, uid: 25345, image_url: User.first.image_url, first_name: "Lemony", last_name: "Snickett", email: "johannusvogel@gmail.com")
# User.create(provider: User.first.provider, uid: 25445, image_url: User.first.image_url, first_name: "Jones", last_name: "Marquett", email: "johansvogel@gmail.com")
